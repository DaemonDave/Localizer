//constants.h
/* $Id: constants.h,v 1.2 2005/06/06 18:53:07 dave Exp $ */
#ifndef CONSTANTS_H
#define CONSTANTS_H
...
typedef struct 
{
	int				id;							// ID of the ellipsoid
	char 			name[40];				// name of the ellipsoid
	double 		equat_radius;		// estimated equatorial radius
	double 		sqr_eccentricity;// square of eccentricity

}c_ellipsoid;

static c_ellipsoid  ellipsoid_array[] = {
// array of ellipsoid elements
//  id, Ellipsoid name, Equatorial Radius, square of eccentricity	
